...
/* because we define FLASH_SIZE in config.db12x */
#ifndef FLASH_SIZE
#define FLASH_SIZE 8
#endif
...
#define CONFIG_AG7240_SPEPHY	/* use eth1(LAN) as the net interface */
#endif
...
#define CONFIG_COMMANDS (CFG_CMD_LOADB | CFG_CMD_MEMORY | CFG_CMD_FLASH | CFG_CMD_NET | CFG_CMD_MII | CFG_CMD_PING | CFG_CMD_ETHREG)
